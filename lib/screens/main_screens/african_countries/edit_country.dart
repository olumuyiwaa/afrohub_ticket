...
class _EditCountryState extends State<EditCountry> {
  ...
  void initState() {
    super.initState();
    getUserInfo();
    countryDescription.text = widget.description;
    countryCapital.text = widget.capital;
    countryCurrency.text = widget.currency;
    countryPopulation.text = widget.population;
    countryDemonym.text = widget.demonym;
    countryLanguage.text = widget.language;
    countryTimeZone.text = widget.timeZone;
    countryPresident.text = widget.president;
    countryCuisinesLink.text = widget.cuisinesLink;
    email.text = widget.email;
    phoneNumber.text = widget.number;
    leaderName.text = widget.name;
  }
