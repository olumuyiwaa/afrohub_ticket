...
class HelpPage extends StatelessWidget {
  ...
  void _openEmail() async {
    final Uri emailUri = Uri(
      scheme: 'mailto',
      path: 'oladoyinemmanuel@gmail.com',
  ...
  void _callPhoneNumber() {
    // Implement phone call functionality here, e.g., using the url_launcher package
  }

  void _openWebsite() {
    // Implement website functionality here, e.g., using the url_launcher package
  }
}
